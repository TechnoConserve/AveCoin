...
"""Verify that starting avecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start avecoin with -h for help text")
        ...
        self.log.info("Start avecoin with -version for version information")
        ...
        self.log.info("Start avecoind with -fakearg to make sure it does not start")
