...
"""AveCoin P2P network half-a-node.
...
class P2PConnection(asyncio.Protocol):
    ...
    def peer_connect(self, dstaddr, dstport, net="regtest"):
        ...
        self.recvbuf = b""
        self.network = net
        logger.debug('Connecting to AveCoin Node: %s:%d' % (self.dstaddr, self.dstport))
...
class P2PInterface(P2PConnection):
    """A high-level P2P interface class for communicating with a AveCoin node.
