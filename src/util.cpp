...
const char * const BITCOIN_CONF_FILENAME = "avecoin.conf";
const char * const BITCOIN_PID_FILENAME = "avecoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "AveCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/AveCoin";
#else
    // Unix
    return pathRet / ".avecoin";
#endif
#endif
}
