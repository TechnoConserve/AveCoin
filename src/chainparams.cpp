...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.avecoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.avecointools.com");
        vSeeds.emplace_back("dnsseed.avecoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.avecointools.com");
        vSeeds.emplace_back("seed-b.avecoin.loshan.co.uk");
