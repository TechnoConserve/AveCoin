...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " avecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  avecoin-tx [options] <hex-tx> [commands]  Update hex-encoded avecoin transaction\n" +
            "or:     avecoin-tx [options] -create [commands]   Create hex-encoded avecoin transaction\n" +
            "\n";
