...
* avecoin.conf: contains configuration settings for avecoind or avecoin-qt
* avecoind.pid: stores the process id of avecoind while running
...
* debug.log: contains debug information and general logging generated by avecoind or avecoin-qt
