# Support for Output Descriptors in AveCoin Core

Since AveCoin Core v0.17, there is support for Output Descriptors in the
...
on AveCoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing AveCoin Core wallets, a convenience function `combo` is
