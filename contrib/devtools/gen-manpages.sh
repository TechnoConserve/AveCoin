...
LITECOIND=${BITCOIND:-$BINDIR/avecoind}
LITECOINCLI=${BITCOINCLI:-$BINDIR/avecoin-cli}
LITECOINTX=${BITCOINTX:-$BINDIR/avecoin-tx}
LITECOINQT=${BITCOINQT:-$BINDIR/qt/avecoin-qt}
